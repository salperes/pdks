...
export const SettingsPage = () => {
  ...
  // Notification & messaging settings (unified)
  ...
  useEffect(() => {
    ...
    fetchNotifLogs();
    fetchPortalSettings();
  }, [fetchSettings, fetchHolidays, fetchSysInfo, fetchBackupHistory, fetchNotifSettings, fetchNotifLogs, fetchPortalSettings]);
  ...
  const btnOutline =
    'inline-flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-lg border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors disabled:opacity-50';
  const thClass =
